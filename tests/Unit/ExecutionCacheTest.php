...
it('can set and get value from cache', function () {
...
it('can delete value from cache', function () {
    $this->cache->set('key1', 'value1');
...
it('implements LRU eviction when max size reached', function () {
...
it('can export and import cache', function () {
    $this->cache->set('key1', 'value1');
    $this->cache->set('key2', 'value2');
...
it('can store complex values', function () {
    $complexValue = [
        'array' => [1, 2, 3],
        'string' => 'test',
        'nested' => ['a' => 'b'],
...
it('overwrites existing key without increasing size', function () {
    $this->cache->set('key1', 'value1');
