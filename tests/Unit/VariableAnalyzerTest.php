...
it('detects used variables', function () {
    $code = '<?php $result = $x + $y;';
...
it('detects defined variables', function () {
    $code = '<?php $result = $x + $y;';
    $ast = $this->parser->parse($code);
...
it('excludes special variables from used', function () {
...
it('gets parameters correctly', function () {
    $code = '<?php
    $result = $x + $y;
    $z = $result * 2;';
    $ast = $this->parser->parse($code);
...
it('gets local variables correctly', function () {
    $code = '<?php
    $temp = $input * 2;
    $result = $temp + 1;';
    $ast = $this->parser->parse($code);
...
it('handles array access', function () {
...
it('handles property access', function () {
...
it('ignores variables in nested functions', function () {
    $code = '<?php
    $outer = 1;
    function inner() {
        $inner = 2;
...
it('handles function calls with variables', function () {
...
it('handles ternary operator', function () {
