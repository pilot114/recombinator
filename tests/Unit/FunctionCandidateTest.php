...
it('matches pure block rule correctly', function () {
    $code = '<?php
    $a = 1;
    $b = 2;
    $c = 3;
...
it('does not match pure block rule for small blocks', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 3, // Too small (< 5)
...
it('matches effect block rule correctly', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
...
it('does not match effect block rule for PURE type', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 3,
...
it('does not match effect block rule for MIXED type', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
...
it('is viable when matches pure block rule', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 5,
...
it('is viable when matches effect block rule', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::IO,
        size: 3,
...
it('calculates priority correctly for pure block', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 5,
...
it('calculates lower priority for IO block', function () {
...
it('suggests function name for pure block', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 5,
...
it('suggests function name for IO block', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::IO,
        size: 3,
...
it('gets function parameters correctly', function () {
    $candidate = new FunctionCandidate(
        nodes: [],
        effectType: SideEffectType::PURE,
        size: 5,
