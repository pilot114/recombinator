...
it(
    ...
    echo "Distance: " . $distance;';
        ...
        $pureCandidate = array_find($candidates, fn($candidate) => $candidate->matchesPureBlockRule());
...
it(
    ...
    echo "===============\n";';
        ...
        $recovery = new AbstractionRecovery();
        $candidates = $recovery->analyze($markedAst);
        $ioCandidate = array_find($candidates, fn($candidate) => $candidate->matchesEffectBlockRule());
