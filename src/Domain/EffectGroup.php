...
/**
 * Группа узлов с одним типом побочного эффекта
 *
 * Содержит узлы AST, классифицированные по одному типу побочного эффекта
 * (PURE, IO, DATABASE и т.д.). Используется для группировки и оптимизации
 * операций одного типа, а также для анализа возможности переупорядочивания кода.
 */
class EffectGroup
{
    /**
