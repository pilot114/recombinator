...
/**
 * Сравнение метрик сложности до и после оптимизации
 *
 * Вычисляет дельту изменений и процент улучшения метрик
 * для оценки эффективности примененных трансформаций.
 */
