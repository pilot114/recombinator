...
/**
 * Результат анализа и разделения побочных эффектов
 *
 * Содержит результаты работы SideEffectSeparator: группы узлов по типам эффектов,
 * чистые вычисления, границы между эффектами, граф зависимостей и статистику.
 * Используется для последующей оптимизации и рефакторинга кода.
 */
