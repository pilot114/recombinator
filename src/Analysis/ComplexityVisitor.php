...
/**
 * Visitor для вычисления когнитивной сложности выражений
 *
 * Подсчитывает сложность кода на основе различных метрик: количество бинарных операций,
 * вызовов функций, уровень вложенности, доступ к массивам/свойствам. Используется
 * для выявления сложных выражений, которые следует упростить или разбить на части.
 */
