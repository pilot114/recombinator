...
/**
 * Предупреждение о сложности кода
 *
 * Представляет информацию о проблемах со сложностью: превышение порогов,
 * увеличение сложности после рефакторинга или улучшения. Используется
 * ComplexityController для отслеживания и отчетности по изменениям сложности.
 */
